...
First, we load the data and measure the mean over our sample. We will use the height Data from National Health Interview Survey (NHIS) 2007.

```{r echo=F}
DataFrame <- read.csv("NHIS2007.csv")
ObservedHeights <- DataFrame$height
head(ObservedHeights)
